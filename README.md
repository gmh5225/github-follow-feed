...
- 🌟 👤 [byt3bl33d3r](https://github.com/byt3bl33d3r) Starred [514-labs/dnsglobe](https://github.com/514-labs/dnsglobe)
...
- 🍴 👤 [classic130](https://github.com/classic130) Forked [bluechips-zhao/av-evasion-skills](https://github.com/bluechips-zhao/av-evasion-skills) to [classic130/av-evasion-skills](https://github.com/classic130/av-evasion-skills)
  > AI AV Evasion Skill v4.0 是一套完整的 Shellcode 免杀方案，采用模块践踏（Module Stomping）、IPv4 混淆、XOR 加密、HeapAlloc 缓冲以及...

### [extremecoders-re](https://github.com/extremecoders-re)
- 🌟 👤 [extremecoders-re](https://github.com/extremecoders-re) Starred [facebook/astryx](https://github.com/facebook/astryx)
