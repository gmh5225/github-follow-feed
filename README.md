...
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [LSPosed/LSPromise](https://github.com/LSPosed/LSPromise) to [CrackerCat/LSPromise](https://github.com/CrackerCat/LSPromise)
...
- 🌟 👤 [Dax89](https://github.com/Dax89) Starred [Fyyre/secrep](https://github.com/Fyyre/secrep)
...
- 🌟 👤 [fvrmatteo](https://github.com/fvrmatteo) Starred [LSPosed/LSPromise](https://github.com/LSPosed/LSPromise)
  > Android complete exploit chain that enables privilege escalation from a local untrusted app to root/...
- 🌟 👤 [fvrmatteo](https://github.com/fvrmatteo) Starred [Supersonic/TLPE](https://github.com/Supersonic/TLPE)
  > CVE-2026-49881, a logic issue in the InCallController class in Android 17's Telecom service that all...

### [hgarrereyn](https://github.com/hgarrereyn)
- 🍴 👤 [hgarrereyn](https://github.com/hgarrereyn) Forked [marijnheule/dpr-trim](https://github.com/marijnheule/dpr-trim) to [hgarrereyn/dpr-trim](https://github.com/hgarrereyn/dpr-trim)
  > Checker of DPR proof files

### [holly-hacker](https://github.com/holly-hacker)
- 🌟 👤 [holly-hacker](https://github.com/holly-hacker) Starred [tristanbuckmaster/fluid_lean](https://github.com/tristanbuckmaster/fluid_lean)
...
- 🌟 👤 [mgeeky](https://github.com/mgeeky) Starred [bytewreck/DumpGuard](https://github.com/bytewreck/DumpGuard)
...
- 🌟 👤 [petercunha](https://github.com/petercunha) Starred [petercunha/dlss-media-player](https://github.com/petercunha/dlss-media-player)
  > Media player with DLSS neural enhancement, live RTX VSR/HDR, Streamlink playback, and optional RIFE ...
...
- 🌟 👤 [ri-char](https://github.com/ri-char) Starred [ADCDS/openwrt-xiaomi-ax3000t-rd03v2](https://github.com/ADCDS/openwrt-xiaomi-ax3000t-rd03v2)
  > Pure mainline-based OpenWrt for the Xiaomi Mi Router AX3000T (RD03v2, IPQ5018): AN8855 2.5G switch, ...

### [wonderzdh](https://github.com/wonderzdh)
- 🌟 👤 [wonderzdh](https://github.com/wonderzdh) Starred [thalium/rumba](https://github.com/thalium/rumba)
  > Cracking MBAs
