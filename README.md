...
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [TroyeFryant/zygiskNodeInfo](https://github.com/TroyeFryant/zygiskNodeInfo) to [CrackerCat/zygiskNodeInfo](https://github.com/CrackerCat/zygiskNodeInfo)
  > 不开无障碍：用 Zygisk 从目标进程内部直读 View 树的自动化取数方案
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [testdriveupgrade/XenonRecompUnlimited](https://github.com/testdriveupgrade/XenonRecompUnlimited) to [CrackerCat/XenonRecompUnlimited](https://github.com/CrackerCat/XenonRecompUnlimited)
  > XenonRecompUnlimited - it's special fork of XenonRecomp for TDU engine, like experimental fork-versi...
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [baitaotao521/traffic_consumer](https://github.com/baitaotao521/traffic_consumer) to [CrackerCat/traffic_consumer](https://github.com/CrackerCat/traffic_consumer)
  > 流量消耗器 
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [SoyBeanMilkx/dbi_detect](https://github.com/SoyBeanMilkx/dbi_detect) to [CrackerCat/dbi_detect](https://github.com/CrackerCat/dbi_detect)
...
- 🌟 👤 [XINCGer](https://github.com/XINCGer) Starred [makecindy/cindy](https://github.com/makecindy/cindy)
  > Consider it done. The open-source AI agent that works out of the box · 想到，就能做到。开源、开箱即用的 AI Agent。
- 🌟 👤 [XINCGer](https://github.com/XINCGer) Starred [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md)
...
- 🌟 👤 [killvxk](https://github.com/killvxk) Starred [imbas007/POC-CVE-2026-60206](https://github.com/imbas007/POC-CVE-2026-60206)
  > cve cve-2026-60206 weblogic saml exploit poc vulnerability oracle scanner security
- 🍴 👤 [killvxk](https://github.com/killvxk) Forked [imbas007/POC-CVE-2026-60206](https://github.com/imbas007/POC-CVE-2026-60206) to [killvxk/POC-CVE-2026-60206](https://github.com/killvxk/POC-CVE-2026-60206)
  > cve cve-2026-60206 weblogic saml exploit poc vulnerability oracle scanner security
- 🌟 👤 [killvxk](https://github.com/killvxk) Starred [kylekkkk61/goal-watchdog](https://github.com/kylekkkk61/goal-watchdog)
...
- 🌟 👤 [lightclient](https://github.com/lightclient) Starred [studebaker8/cmp170hx-gen2](https://github.com/studebaker8/cmp170hx-gen2)
  > PCIe Gen1 to Gen2 on the NVIDIA CMP 170HX: retrain the link inside the transient window the cmpunloc...
...
- 🌟 👤 [wonderzdh](https://github.com/wonderzdh) Starred [idalib-rs/idalib](https://github.com/idalib-rs/idalib)
