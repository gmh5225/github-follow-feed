...
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [sunblaze-ucb/exploitgym-results](https://github.com/sunblaze-ucb/exploitgym-results) to [CrackerCat/exploitgym-results](https://github.com/CrackerCat/exploitgym-results)
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [Vikramaditya015/samsung-android-lpe](https://github.com/Vikramaditya015/samsung-android-lpe) to [CrackerCat/samsung-android-lpe](https://github.com/CrackerCat/samsung-android-lpe)
  > Poc for CVE-2026-20980, CVE-2026-20981, CVE-2026-20982
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [YuKongA/Mishka](https://github.com/YuKongA/Mishka) to [CrackerCat/Mishka](https://github.com/CrackerCat/Mishka)
  > [Android] A mihomo GUI
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [a6216abcd/Free-Residential-IP-Proxy-Controller](https://github.com/a6216abcd/Free-Residential-IP-Proxy-Controller) to [CrackerCat/Free-Residential-IP-Proxy-Controller](https://github.com/CrackerCat/Free-Residential-IP-Proxy-Controller)
...
- 🌟 👤 [RicBent](https://github.com/RicBent) Starred [MakrSas/Inferno](https://github.com/MakrSas/Inferno)
  > Unofficial fork of Inferno that runs as a library inside an iPhone app

### [XaFF-XaFF](https://github.com/XaFF-XaFF)
- 🌟 👤 [XaFF-XaFF](https://github.com/XaFF-XaFF) Starred [Idov31/Silverseal](https://github.com/Idov31/Silverseal)
  > Silverseal is a Linux framework containing a bootkit, rootkit loader and a rootkit

### [byt3bl33d3r](https://github.com/byt3bl33d3r)
- 🌟 👤 [byt3bl33d3r](https://github.com/byt3bl33d3r) Starred [agamrossen/VolAnti](https://github.com/agamrossen/VolAnti)
  > Open-source acoustic drone detection. It hears the propellers, not the radio, so it works against fi...
- 🌟 👤 [byt3bl33d3r](https://github.com/byt3bl33d3r) Starred [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)
  > VictoriaMetrics: fast, cost-effective monitoring solution and time series database
- 🌟 👤 [byt3bl33d3r](https://github.com/byt3bl33d3r) Starred [vectordotdev/vector](https://github.com/vectordotdev/vector)
  > A high-performance observability data pipeline.
- 🌟 👤 [byt3bl33d3r](https://github.com/byt3bl33d3r) Starred [iwe-org/iwe](https://github.com/iwe-org/iwe)
  > Markdown knowledge graph — LSP for your editor, CLI + MCP memory for your AI agents
- 🌟 👤 [byt3bl33d3r](https://github.com/byt3bl33d3r) Starred [oxc-project/oxc](https://github.com/oxc-project/oxc)
