...
- 🌟 👤 [Ben-Lichtman](https://github.com/Ben-Lichtman) Starred [sandboxie-plus/Sandboxie](https://github.com/sandboxie-plus/Sandboxie)
  > Sandboxie Plus & Classic
- 🌟 👤 [Ben-Lichtman](https://github.com/Ben-Lichtman) Starred [lzty/vdem](https://github.com/lzty/vdem)
  > Vulnerable driver exploit manager
- 🌟 👤 [Ben-Lichtman](https://github.com/Ben-Lichtman) Starred [lzty/CVE-2026-94128](https://github.com/lzty/CVE-2026-94128)
  > POC for CVE-2026-94128
- 🌟 👤 [Ben-Lichtman](https://github.com/Ben-Lichtman) Starred [lzty/CVE-2026-94129](https://github.com/lzty/CVE-2026-94129)
  > A POC for CVE-2026-94129
- 🌟 👤 [Ben-Lichtman](https://github.com/Ben-Lichtman) Starred [mowisec/imessage](https://github.com/mowisec/imessage)
- 🌟 👤 [Ben-Lichtman](https://github.com/Ben-Lichtman) Starred [mowisec/insert_kext](https://github.com/mowisec/insert_kext)
  > Patch an open-source kext into a closed-source iOS kernelcache binary.
- 🌟 👤 [Ben-Lichtman](https://github.com/Ben-Lichtman) Starred [Ledger-Donjon/zorya](https://github.com/Ledger-Donjon/zorya)
  > Zorya: Automated Concolic Execution Engine optimized for Go Binaries analysis, using Ghidra's P-Code...
...
- 🌟 👤 [frkngksl](https://github.com/frkngksl) Starred [marcosd4h/MDMatador](https://github.com/marcosd4h/MDMatador)
  > MDM-based Agentless C2 System
- 🌟 👤 [frkngksl](https://github.com/frkngksl) Starred [oscartbeaumont/windows_mdm](https://github.com/oscartbeaumont/windows_mdm)
  > A Windows MDM Proof of Concept Written In Go Lang

### [hzqst](https://github.com/hzqst)
- 🍴 👤 [hzqst](https://github.com/hzqst) Forked [lsmallice/cliproxyapi-provider-rate-limiter-plugin](https://github.com/lsmallice/cliproxyapi-provider-rate-limiter-plugin) to [hzqst/cliproxyapi-provider-rate-limiter-plugin](https://github.com/hzqst/cliproxyapi-provider-rate-limiter-plugin)
- 🍴 👤 [hzqst](https://github.com/hzqst) Forked [rheodev/cpa-plugin-privacyfilter](https://github.com/rheodev/cpa-plugin-privacyfilter) to [hzqst/cpa-plugin-privacyfilter](https://github.com/hzqst/cpa-plugin-privacyfilter)
  > A native privacy filter plugin for CLIProxyAPI. It intercepts model requests, detects sensitive text...
